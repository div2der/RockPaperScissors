...
const connectContract = async () => {
    if (typeof window !== 'undefined') {
        ...
        const Address = "0x8658E1D6CC2dFfCfB66F08Cc60365C43e5737f42";
...
const chooseRock = async() => {
    ...
    if (gestures[randomIndex] == "Scissors") {
        ...
        await window.contract.methods.withdraw("0xF29745250f4762Ca3eB1267ACB20Fc8DD45C764e", amountToTransfer * 2).send({from: account});
    ...
    if (gestures[randomIndex] == "Rock") {
        ...
        await window.contract.methods.withdraw("0xF29745250f4762Ca3eB1267ACB20Fc8DD45C764e", amountToTransfer).send({from: account});
